...
export const PRODUCTS: Product[] = [
  {
    ...
    benefits: [
      "植物來源 EAA，提供身體容易吸收的胺基酸補充。",
      "含 9 種必需胺基酸，補足日常蛋白質攝取所需。",
      "富含膳食纖維，有助維持消化道正常機能及飽足感。",
      "無添加人工甘味劑及精製糖，保留食材天然風味。",
      "補充多種微量元素與維生素，支持日常均衡飲食所需。",
    ],
    ingredients: [
      "大豆分離蛋白",
      "芝麻蛋白",
  ...
  },
  {
    ...
    benefits: [
      "高利用率 EAA 配方，補充每日蛋白質需求不遺漏。",
      "PDCAAS=1 黃金比例，完整補充 9 種必需胺基酸。",
      "富含膳食纖維，有助維持消化道正常機能。",
      "無添加糖與人工代糖，以黑芝麻天然醇香為本。",
      "每日一杯，補充多種微量元素與維生素。",
    ],
  ...
  },
  {
    ...
    dietaryBadge: "奶素可食",
    benefits: [
      "黃金比例 MSM 與薑黃，支持日常行動的輕盈節奏。",
      "精選小分子植萃胜肽，補充日常行動所需蛋白質基底。",
      "含維生素 K2，補充日常所需微量元素。",
      "搭配專利胡椒鹼，有助提升配方吸收效率。",
      "台灣嚴格製造，無多餘添加，保留純粹植萃配方。",
    ],
    ingredients: [
      "大豆分離蛋白",
      "定序大豆胜肽",
